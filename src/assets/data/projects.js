...
const projects = [
  ...
  },
  {
    ...
    stats: [
      ...
      { label: "Platforms", value: "web,ㅤiOS,ㅤandroid" },
      { label: "Framework", value: "reactㅤ&ㅤReact Native" },
      { label: "Responsive", value: "mobileㅤ&ㅤdesktop" },
      { label: "Status", value: "notㅤcompleted" },
    ],
  ...
  },
  {
    ...
    stats: [
      { label: "Type", value: "inventoryㅤmanagementㅤsystem" },
      { label: "Platforms", value: "web" },
      { label: "Framework", value: "react" },
      { label: "Responsive", value: "mobileㅤ&ㅤdesktop" },
